...
class TestLLMFactory:
    ...
    def test_openai_provider_returns_openai_llm(self) -> None:
        with patch("src.workflows.llm_configuration.ChatOpenAI") as mock_openai:
    ...
    def test_ollama_provider_returns_ollama_llm(self) -> None:
        with patch("src.workflows.llm_configuration.ChatOllama") as mock_ollama:
    ...
    def test_create_llm_stores_temperature(self) -> None:
        with patch("src.workflows.llm_configuration.ChatOpenAI") as mock_openai:
            ...
            llm = LLMFactory.create_llm(
                provider="openai", model_name="gpt-4o-mini", temperature=0.9
            )
