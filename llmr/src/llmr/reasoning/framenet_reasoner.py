...
Annotates :attr:`~llmr.schemas.ActionAnnotationBundle.frames` with a
:class:`~llmr.schemas.FrameNetAnnotation` derived from the original NL
...
from llmr.bridge.match_reader import render_resolved_slots
from llmr.reasoning import Reasoner
from llmr.schemas import FrameNetAnnotation
