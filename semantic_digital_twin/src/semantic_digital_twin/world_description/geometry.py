...
class BoundingBox:
    ...
    def x_interval(self) -> SimpleInterval:
        ...
        """
        return SimpleInterval.from_data(self.min_x, self.max_x, Bound.CLOSED, Bound.CLOSED)
    ...
    def y_interval(self) -> SimpleInterval:
        ...
        """
        return SimpleInterval.from_data(self.min_y, self.max_y, Bound.CLOSED, Bound.CLOSED)
    ...
    def z_interval(self) -> SimpleInterval:
        ...
        """
        return SimpleInterval.from_data(self.min_z, self.max_z, Bound.CLOSED, Bound.CLOSED)
