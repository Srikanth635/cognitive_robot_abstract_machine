...
class QPFormulation:
    ...
    def is_implicit(self) -> bool:
        return (
            self.is_mpc
            and not self.has_explicit_acc_variables
            and not self.has_explicit_jerk_variables
        )
    ...
    def is_explicit(self) -> bool:
        return (
            self.is_mpc
            and self.has_explicit_acc_variables
            and self.has_explicit_jerk_variables
        )
