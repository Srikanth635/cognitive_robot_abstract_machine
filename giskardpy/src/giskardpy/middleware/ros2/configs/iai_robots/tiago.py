...
class TiagoJointTrajServerIAIInterface(RobotInterfaceConfig):
    ...
    def setup(self):
        ...
        self.sync_odometry_topic(
            odometry_topic="/tiago/base_footprint", joint_name=self.drive_joint_name
        )
        ...
        self.add_follow_joint_trajectory_server(
            namespace="/tiago/left_gripper_controller"
        )
        self.add_follow_joint_trajectory_server(
            namespace="/tiago/right_gripper_controller"
        )
        self.add_follow_joint_trajectory_server(namespace="/tiago/torso_controller")
        self.add_base_cmd_velocity(
            cmd_vel_topic="/tiago/cmd_vel", joint_name=self.drive_joint_name
        )
