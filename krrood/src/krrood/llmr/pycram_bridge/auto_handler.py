...
from krrood.llmr.pipeline.dispatcher import ActionHandler, ActionSpec
from krrood.llmr.pipeline.entity_grounder import body_display_name
from krrood.llmr.pycram_bridge.introspector import NO_DEFAULT, ActionSchema, FieldKind, FieldSpec
from krrood.llmr.pycram_bridge.enum_resolver import EnumResolver
...
class AutoActionHandler(ActionHandler):
    ...
    Registered with :class:`~krrood.llmr.pipeline.dispatcher.ActionDispatcher`
    by :class:`~krrood.llmr.pycram_bridge.PycramBridge` for each discovered action.
    ...
    def execute(self, schema: ActionSlotSchema) -> ActionSpec:
        ...
        Call :func:`~krrood.llmr.pycram_bridge.PycramBridge.to_pycram_action` to
    ...
    def _resolve_type_ref(self, fspec: FieldSpec, schema: ActionSlotSchema) -> Any:
        ...
        from krrood.llmr.pipeline.entity_grounder import resolve_symbol_class
