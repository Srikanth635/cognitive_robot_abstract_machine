...
from krrood.llmr.workflows.schemas.common import EntityDescriptionSchema
...
# typing. They are the ONLY place in krrood.llmr that knows about the
...
class EntityGrounder:
    ...
    :param groundable_type: The Symbol subclass representing groundable world
        ...
        krrood.llmr never imports this class directly.
    """
