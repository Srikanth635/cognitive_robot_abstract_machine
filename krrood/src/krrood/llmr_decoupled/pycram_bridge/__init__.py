"""krrood.llmr_decoupled.pycram_bridge — pycram integration layer.
"""
...
from krrood.llmr_decoupled.pipeline.dispatcher import ActionDispatcher, ActionSpec
from krrood.llmr_decoupled.pipeline.entity_grounder import EntityGrounder
from krrood.llmr_decoupled.pycram_bridge.action_registry import PycramActionRegistry
from krrood.llmr_decoupled.pycram_bridge.auto_handler import AutoActionHandler
from krrood.llmr_decoupled.pycram_bridge.introspector import ActionSchema, PycramIntrospector

logger = logging.getLogger(__name__)


class PycramBridge:
    """One-stop entry point for the krrood.llmr_decoupled ↔ pycram integration.
    ...
    def handlers(self) -> Dict[str, type]:
        ...
        dataclass subclass of :class:`~krrood.llmr_decoupled.pycram_bridge.auto_handler.AutoActionHandler`
        that was registered with :class:`~krrood.llmr_decoupled.pipeline.dispatcher.ActionDispatcher`.
        """
