...
- ``build_slot_filler_prompt_from_schemas(schemas)`` — richer mode driven by
  :class:`~krrood.llmr_decoupled.pycram_bridge.introspector.ActionSchema` objects, giving
...
if TYPE_CHECKING:
    from krrood.llmr_decoupled.pycram_bridge.introspector import ActionSchema
...
def build_slot_filler_prompt_from_schemas(
    ...
    """
    from krrood.llmr_decoupled.pycram_bridge.introspector import FieldKind
