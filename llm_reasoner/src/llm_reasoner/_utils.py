"""
Internal utilities shared across llm_reasoner modules.

Keep this module minimal — only genuinely cross-cutting helpers belong here.
No world, pycram, or LLM imports.
"""
