"""
Structured exceptions for llm_reasoner.

All exceptions inherit from :class:`krrood.utils.DataclassException` so they
are dataclass objects with typed fields — consistent with the krrood-wide
exception pattern.
"""
