...
This is the only module in llm_reasoner that imports or scans PyCRAM packages.
The rest of the package depends on these structural protocols and wrapper
functions instead of PyCRAM modules directly.
"""
