...
All SymbolGraph access is delegated to :mod:`llmr_updated_arch.integrations.krrood.world_reader`.
"""
...
from llmr_updated_arch.integrations.krrood.world_reader import (
    symbol_display_name,
    get_instances,
