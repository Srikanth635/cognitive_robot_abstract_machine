...
class FollowToolCenterPointPathActionDAO(
    ...
    target_location: Mapped[PoseTrajectoryDAO] = relationship(
        "PoseTrajectoryDAO",
        uselist=False,
        foreign_keys=[target_location_id],
        post_update=True,
...
class NavigationGoalNotReachedErrorDAO(
    ...
    current_pose: Mapped[PoseStampedDAO] = relationship(
        "PoseStampedDAO",
        uselist=False,
        foreign_keys=[current_pose_id],
        post_update=True,
    )
    goal_pose: Mapped[PoseStampedDAO] = relationship(
        "PoseStampedDAO", uselist=False, foreign_keys=[goal_pose_id], post_update=True
    )
...
class DiffDriveBaseGoalDAO(
    SequenceDAO,
    DataAccessObject[
        giskardpy.motion_statechart.goals.cartesian_goals.DiffDriveBaseGoal
    ],
):

    __tablename__ = "DiffDriveBaseGoalDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "DiffDriveBaseGoalDAO",
